      ...
      <section class="py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="mt-20 text-center">
            <p class="text-xl text-gray-600 mb-6">Ready to build something amazing?</p>
            <router-link to="/vue" class="btn-primary inline-block">
              Start Learning
            </router-link>
          </div>
        </div>
...
.group:hover .aspect-video > div > div {
